...
import { invalidEmailLoginBody, invalidMissingLoginBody, invalidPasswordFormatLoginBody, invalidPasswordLoginBody, userDB, validLoginBody, validToken } from './mocks/userService';
...
describe('Tests Users service and controller', () => {
  ...
  describe('Valid post login', function () {
    ...
    it('returns status 200 with token', async function () {
  ...
  describe('Invalid post login', function () {
    it('returns status 400 with missing fields message', async function () {
    ...
    it('returns status 401 with invalid fields message with wrong format', async function () {
    ...
    it('returns status 401 with invalid fields message with wrong email', async function () {
    ...
    it('returns status 401 with invalid fields message with wrong password', async function () {
  ...
  describe('Gets user role after logging in', function () {
    it('returns status 401 and token not found message', async function () {
    ...
    it('returns status 401 and invalid token message', async function () {
    ...
    it('returns status 200 and the user`s role', async function () {
